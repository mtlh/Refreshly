...
import "./root.css";
import { login, logout, useSession } from "./functions/LoginHooks";
import { addusertodb } from "./functions/user/adduser";
...
export default function Root() {
  ...
  if (session()?.user) {
    addusertodb(session()?.user?.name, session()?.user?.email, session()?.user?.image);
  }
  return (
